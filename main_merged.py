...
def build_parser():
    ...
    parser.add_argument("--od_n", default=20, type=int,
                        help="Number of ood points to sample from JEM")
    parser.add_argument("--od_lr", default=1.7, type=float,
                        help="Gradient scale for JEM ood samples.")
    parser.add_argument("--od_std", default=.2, type=float,
                        help="Sampling noise for JEM ood samples.")
    parser.add_argument("--od_l", default=4.9, type=float,
    ...
    # buffer setting
    parser.add_argument("--buffer_in", type=bool, default=True)
    parser.add_argument("--buffer_out", type=bool, default=True)
